...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
		...
		_gsScope._gsDefine("utils.Draggable", ["events.EventDispatcher", "TweenLite", "plugins.CSSPlugin"], function (a, b, c) {
			var d, e, f, g, h, i, j, k, l, m = {
				...
				Sa = function (d, g) {
					...
					var h, i, j, k, l, r, u, v, x, D, G, K, O, R, T, U, Y, aa, ca, da, ea, fa, ga, ka, la, ma, na, oa, pa, qa, ra, sa, ta = (g.type || (B ? "top,left" : "x,y")).toLowerCase(),
						...
						Xa = function (a, c) {
							var e, f = Da.x,
								g = Da.y;
							d._gsTransform || !ua && !va || b.set(d, {
								x: "+=0",
								overwrite: !1
							}), ua ? (Da.y = d._gsTransform.y, Da.x = d._gsTransform.x) : va ? Da.x = Da.rotation = d._gsTransform.rotation : i ? (Da.y = i.top(), Da.x = i.left()) : (Da.y = parseInt(d.style.top, 10) || 0, Da.x = parseInt(d.style.left, 10) || 0), !da && !ea || c || (da && (e = da(Da.x), e !== Da.x && (Da.x = e, va && (Da.rotation = e))), ea && (e = ea(Da.y), e !== Da.y && (Da.y = e))), (f !== Da.x || g !== Da.y) && Va(!0), a || ia(Da, "throwupdate", "onThrowUpdate")
						},
						Ya = function () {
							var a, b, c, e;
						...
						_a = function (a, b) {
							...
							a && f ? (a === !0 && (c = g.snap || {}, e = c instanceof Array || "function" == typeof c, a = {
								resistance: (g.throwResistance || g.resistance || 1e3) / (va ? 10 : 1)
							}, va ? a.rotation = Na(Da, e ? c : c.rotation, x, D, 1, b) : (ya && (a[wa] = Na(Da, e ? c : c.x || c.left || c.scrollLeft, x, D, i ? -1 : 1, b || "x" === Da.lockedAxis)), za && (a[xa] = Na(Da, e ? c : c.y || c.top || c.scrollTop, G, K, i ? -1 : 1, b || "y" === Da.lockedAxis)))), Da.isThrowing = !0, j = isNaN(g.overshootTolerance) ? 1 === g.edgeResistance ? 0 : 1 - Da.edgeResistance + .2 : g.overshootTolerance, Da.tween = h = f.to(i || d, {
								throwProps: a,
								ease: g.ease || q.Power3.easeOut,
								onComplete: Za,
								onOverwrite: $a,
								onUpdate: g.fastMode ? ia : Xa,
								onUpdateParams: g.fastMode ? [Da, "onthrowupdate", "onThrowUpdate"] : w
							}, isNaN(g.maxDuration) ? 2 : g.maxDuration, isNaN(g.minDuration) ? 0 === j ? 0 : .5 : g.minDuration, j), g.fastMode || (i && (i._suspendTransforms = !0), h.render(h.duration(), !0, !0), Xa(!0, !0), Da.endX = Da.x, Da.endY = Da.y, va && (Da.endRotation = Da.x), h.play(0), Xa(!0, !0), i && (i._suspendTransforms = !1))) : u && Da.applyBounds()
						},
						ab = function () {
							var a, b, c, e, f, g, h, i, l, m = ka || [1, 0, 0, 1, 0, 0];
							ka = Aa(d.parentNode, !0), Da.isPressed && m.join(",") !== ka.join(",") && (a = m[0], b = m[1], c = m[2], e = m[3], f = m[4], g = m[5], h = a * e - b * c, i = j * (e / h) + k * (-c / h) + (c * g - e * f) / h, l = j * (-b / h) + k * (a / h) + -(a * g - b * f) / h, k = i * ka[1] + l * ka[3] + ka[5], j = i * ka[0] + l * ka[2] + ka[4]), ka[1] || ka[2] || 1 != ka[0] || 1 != ka[3] || 0 != ka[4] || 0 != ka[5] || (ka = null)
						},
						bb = function () {
							var a = 1 - Da.edgeResistance;
							ab(), ka && (j = Da.pointerX * ka[0] + Da.pointerY * ka[2] + ka[4], k = Da.pointerX * ka[1] + Da.pointerY * ka[3] + ka[5]), aa && (gb(Da.pointerX, Da.pointerY), Va(!0)), i ? (Ya(), r = i.top(), l = i.left()) : (cb() ? (Xa(!0, !0), Ya()) : Da.applyBounds(), va ? (Y = Ba(d, {
								x: 0,
								y: 0
							}), Xa(!0, !0), l = Da.x, r = Da.y = Math.atan2(Y.y - Da.pointerY, Da.pointerX - Y.x) * y) : (ma = d.parentNode ? d.parentNode.scrollTop || 0 : 0, na = d.parentNode ? d.parentNode.scrollLeft || 0 : 0, r = ha(d, xa), l = ha(d, wa))), u && a && (l > x ? l = x + (l - x) / a : D > l && (l = D - (D - l) / a), va || (r > G ? r = G + (r - G) / a : K > r && (r = K - (K - r) / a)))
						},
						cb = function () {
						...
						eb = function (a) {
							...
							if (!(!h || Da.isPressed || !a || ("mousedown" === a.type || "pointerdown" === a.type) && A() - Ua < 30 && Ha[Da.pointerEvent.type])) {
								if (la = cb(), Da.pointerEvent = a, Ha[a.type] ? (ga = -1 !== a.type.indexOf("touch") ? a.currentTarget || a.target : s, Ia(ga, "touchend", hb), Ia(ga, "touchmove", fb), Ia(ga, "touchcancel", hb), Ia(s, "touchstart", Ma)) : (ga = null, Ia(s, "mousemove", fb)), qa = null, Ia(s, "mouseup", hb), a && a.target && Ia(a.target, "mouseup", hb), fa = Ta.call(Da, a.target) && !g.dragClickables) return Ia(a.target, "change", hb), ia(Da, "press", "onPress"), void Pa(Ea, !0);
								if (pa = !ga || ya === za || i || Da.vars.allowNativeTouchScrolling === !1 ? !1 : ya ? "y" : "x", B ? a = $(a, !0) : pa || Da.allowEventDefault || (a.preventDefault(), a.preventManipulation && a.preventManipulation()), a.changedTouches ? (a = T = a.changedTouches[0], U = a.identifier) : a.pointerId ? U = a.pointerId : T = U = null, H++, P(Va), k = Da.pointerY = a.pageY, j = Da.pointerX = a.pageX, (pa || Da.autoScroll) && Z(d.parentNode), !Da.autoScroll || va || i || !d.parentNode || d.getBBox || !d.parentNode._gsMaxScrollX || C.parentNode || (C.style.width = d.parentNode.scrollWidth + "px", d.parentNode.appendChild(C)), bb(), Da.tween && Da.tween.kill(), Da.isThrowing = !1, b.killTweensOf(i || d, !0, Fa), i && b.killTweensOf(d, !0, {
										scrollTo: 1
									}), Da.tween = Da.lockedAxis = null, (g.zIndexBoost || !va && !i && g.zIndexBoost !== !1) && (d.style.zIndex = Sa.zIndex++), Da.isPressed = !0, v = !(!g.onDrag && !Da._listeners.drag), !va)
						...
						fb = function (a) {
							...
							if (h && !e && Da.isPressed && a) {
								...
								if (B) a = $(a, !0);
									...
									if (ga && pa && !qa && (c = a.pageX, d = a.pageY, ka && (f = c * ka[0] + d * ka[2] + ka[4], d = c * ka[1] + d * ka[3] + ka[5], c = f), qa = Math.abs(c - j) > Math.abs(d - k) && ya ? "x" : "y", Da.vars.lockAxisOnTouchScroll !== !1 && (Da.lockedAxis = "x" === qa ? "y" : "x", "function" == typeof Da.vars.onLockAxis && Da.vars.onLockAxis.call(Da, g)), I && pa === qa)) return void hb(g);
						...
						hb = function (a, c) {
							if (h && Da.isPressed && (!a || null == U || c || !(a.pointerId && a.pointerId !== U || a.changedTouches && !Ka(a.changedTouches, U)))) {
								...
								var e, f, i, j, k = a,
									l = Da.isDragging;
								if (ga ? (Ja(ga, "touchend", hb), Ja(ga, "touchmove", fb), Ja(ga, "touchcancel", hb), Ja(s, "touchstart", Ma)) : Ja(s, "mousemove", fb), Ja(s, "mouseup", hb), a && a.target && Ja(a.target, "mouseup", hb), aa = !1, C.parentNode && C.parentNode.removeChild(C), fa) return a && Ja(a.target, "change", hb), Pa(Ea, !1), ia(Da, "release", "onRelease"), ia(Da, "click", "onClick"), void(fa = !1);
								if (Q(Va), !va)
									for (f = Ea.length; --f > -1;) ba(Ea[f], "cursor", g.cursor || "move");
						...
						jb = function (a) {
							var b = A(),
								c = 40 > b - Ua,
								d = 40 > b - La;
							return c && sa !== Ua ? void(sa = Ua) : void((Da.isPressed || d || c) && (a.preventDefault ? (a.preventDefault(), (c || d && Da.vars.suppressClickOnDrag !== !1) && a.stopImmediatePropagation()) : a.returnValue = !1, a.preventManipulation && a.preventManipulation()))
						};
					ca = Sa.get(this.target), ca && ca.kill(), this.startDrag = function (a) {
						...
						var c, d, e, g, h, i, j = "velocity" === a && f ? a : "object" != typeof a || va ? "start" : "element";
						return "element" === j && (h = Wa(Da.target), i = Wa(a)), c = "start" === j ? Da.x - l : "velocity" === j ? f.getVelocity(this.target, wa) : h.left + h.width / 2 - (i.left + i.width / 2), va ? 0 > c ? "counter-clockwise" : "clockwise" : (b = b || 2, d = "start" === j ? Da.y - r : "velocity" === j ? f.getVelocity(this.target, xa) : h.top + h.height / 2 - (i.top + i.height / 2), e = Math.abs(c / d), g = 1 / b > e ? "" : 0 > c ? "left" : "right", b > e && ("" !== g && (g += "-"), g += 0 > d ? "up" : "down"), g)
					}, this.applyBounds = function (a) {
						var b, c, e, f, h, i;
						if (a && g.bounds !== a) return g.bounds = a, Da.update(!0);
						if (Xa(!0), Ya(), u) {
							if (b = Da.x, c = Da.y, b > x ? b = x : D > b && (b = D), c > G ? c = G : K > c && (c = K), (Da.x !== b || Da.y !== c) && (e = !0, Da.x = Da.endX = b, va ? Da.endRotation = b : Da.y = Da.endY = c, aa = !0, Va(!0), Da.autoScroll && !Da.isDragging))
						...
						var c = Da.x,
							e = Da.y;
						return ab(), a ? Da.applyBounds() : (aa && b && Va(!0), Xa(!0)), Da.isPressed && (ya && Math.abs(c - Da.x) > .01 || za && Math.abs(e - Da.y) > .01 && !va) && bb(), Da.autoScroll && (Z(d.parentNode), Qa = Da.isDragging, Va(!0)), Da.autoScroll && (W(d, ib), V(d, ib)), Da
					}, this.enable = function (a) {
						var e, j, k;
						if ("soft" !== a) {
							for (j = Ea.length; --j > -1;) k = Ea[j], Ia(k, "mousedown", eb), Ia(k, "touchstart", eb), Ia(k, "click", jb, !0), va || ba(k, "cursor", g.cursor || "move"), ba(k, "touchCallout", "none"), ba(k, "touchAction", ya === za || i ? "none" : ya ? "pan-y" : "pan-x");
							Pa(Ea, !1)
						}
						return V(d, ib), h = !0, f && "soft" !== a && f.track(i || d, ua ? "x,y" : va ? "rotation" : "top,left"), i && i.enable(), d._gsDragID = e = "d" + F++, E[e] = this, i && (i.element._gsDragID = e), b.set(d, {
							x: "+=0",
							overwrite: !1
						}), oa = {
							t: d,
						...
						var b, c, e = Da.isDragging;
						if (!va)
							for (b = Ea.length; --b > -1;) ba(Ea[b], "cursor", null);
						if ("soft" !== a) {
						...
						return W(d, ib), h = !1, f && "soft" !== a && f.untrack(i || d, ua ? "x,y" : va ? "rotation" : "top,left"), i && i.disable(), Q(Va), Da.isDragging = Da.isPressed = fa = !1,
							e && ia(Da, "dragend", "onDragEnd"), Da
					...
					}, -1 !== ta.indexOf("scroll") && (i = this.scrollProxy = new Ra(d, S({
						onKill: function () {
							Da.isPressed && hb(null)
						}
					}, g)), d.style.overflowY = za && !Ga ? "auto" : "hidden", d.style.overflowX = ya && !Ga ? "auto" : "hidden", d = i.content), g.force3D !== !1 && b.set(d, {
						force3D: !0
					}), va ? Fa.rotation = 1 : (ya && (Fa[wa] = 1), za && (Fa[xa] = 1)), va ? (O = p, R = O.css, O.overwrite = !1) : ua && (O = ya && za ? m : ya ? n : o, R = O.css, O.overwrite = !1), this.enable()
				},
				Ta = Sa.prototype = new a;
			Ta.constructor = Sa, Ta.pointerX = Ta.pointerY = 0, Ta.isDragging = Ta.isPressed = !1, Sa.version = "0.14.6", Sa.zIndex = 1e3, Ia(s, "touchcancel", function () {}), Ia(s, "contextmenu", function (a) {
				var b;
	...
	function (a) {
		...
		"function" == typeof define && define.amd ? define(["TweenLite"], b) : "undefined" != typeof module && module.exports && (require("../TweenLite.js"), require("../plugins/CSSPlugin.js"), module.exports = b())
	}("Draggable");