var rowSize   = 10; // => container height / number of items
var container = document.querySelector(".container12");
var listItems = Array.from(document.querySelectorAll(".list-item12")); // Array of elements
...
function Sortable(element, index) {
  ...
  var content = element.querySelector(".item-content12");
