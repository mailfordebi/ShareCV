    ...
    <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="about">
      <div class="w-100">
        ...
        <c:if test="${not empty cvInfo.linkedin}">
          <a href="${cvInfo.linkedin}" target="_blank">
            <i class="fab fa-linkedin-in"></i>
          </a>
          </c:if>
          <c:if test="${not empty cvInfo.github}">
          <a href="${cvInfo.github}" target="_blank">
            <i class="fab fa-github"></i>
          </a>
          </c:if>
          <c:if test="${not empty cvInfo.twitter}">
          <a href="${cvInfo.twitter}" target="_blank">
            <i class="fab fa-twitter"></i>
          </a>
          </c:if>
          <c:if test="${not empty cvInfo.facebook}">
          <a href="${cvInfo.facebook}" target="_blank">
            <i class="fab fa-facebook-f"></i>
          </a>
          </c:if>
          <c:if test="${not empty cvInfo.stackoverflow}">
          <a href="${cvInfo.stackoverflow}" target="_blank">
